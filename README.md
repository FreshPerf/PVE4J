...
<p align="center">
  ...
  <a href="https://central.sonatype.com/artifact/fr.freshperf/PVE4J"><img src="https://img.shields.io/badge/release-0.2.1-green" alt="Maven Central"></a>
...
```groovy
dependencies {
    implementation 'fr.freshperf:PVE4J:0.2.1'
}
```
