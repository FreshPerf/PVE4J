package fr.freshperf.proxmox4j.integration;
...
import fr.freshperf.proxmox4j.entities.access.PveAccessUser;
import fr.freshperf.proxmox4j.entities.cluster.resources.PveClusterResources;
import fr.freshperf.proxmox4j.entities.nodes.PveNodesIndex;
import fr.freshperf.proxmox4j.entities.nodes.node.PveNode;
import fr.freshperf.proxmox4j.entities.nodes.node.lxc.PveLxcIndex;
import fr.freshperf.proxmox4j.entities.nodes.node.qemu.PveQemuConfig;
import fr.freshperf.proxmox4j.entities.nodes.node.qemu.PveQemuIndex;
import fr.freshperf.proxmox4j.entities.nodes.node.qemu.PveQemuStatus;
import fr.freshperf.proxmox4j.entities.nodes.node.qemu.PveQemuVm;
import fr.freshperf.proxmox4j.entities.nodes.node.storage.PveStorageIndex;
